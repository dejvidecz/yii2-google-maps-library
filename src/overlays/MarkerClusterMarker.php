 ...
 */
class MarkerClusterMarker extends MarkerOptions
{
    use OverlayTrait;
    ...
    public static function getCenterOfMarkers($markers)
    {
        ...
        foreach ($markers as $marker) {
            if (!($marker instanceof MarkerClusterMarker)) {
    ...
    protected function getInfoWindowJs()
    {
        ...
        if ($this->infoWindow !== null) {
            if ($this->isInfoWindowShared) {
                ...
                if ($this instanceof MarkerClusterMarker) {
                    $js = $this->infoWindow->getJs();
                    $js.=
                        "{$this->infoWindow->getName()}.setContent('{$this->infoWindow->content}');\n" .
                        "{$this->infoWindow->getName()}.open($map, this);\n";
                } else {
                    $js =
